...
set env CURRENT_DEF ./tmp/cts/11-alu.resized.def
set env CURRENT_NETLIST ./tmp/cts/11-alu.resized.nl.v
set env CURRENT_ODB ./tmp/cts/11-alu.resized.odb
set env CURRENT_POWERED_NETLIST ./tmp/cts/11-alu.resized.pnl.v
set env CURRENT_SDC ./tmp/cts/11-alu.resized.sdc
...
set env PACKAGED_SCRIPT_7 ./tmp/cts/11-alu.resized.sdc
set env PACKAGED_SCRIPT_8 ./tmp/12-alu.sdc
...
set env SAVE_DEF ./tmp/12-alu.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./tmp/12-alu.odb
set env SAVE_POWERED_NETLIST ./tmp/12-alu.pnl.v
set env SAVE_SDC ./tmp/12-alu.sdc
