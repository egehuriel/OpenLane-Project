...
export CURRENT_DEF='./tmp/cts/11-alu.resized.def';
export CURRENT_NETLIST='./tmp/cts/11-alu.resized.nl.v';
export CURRENT_ODB='./tmp/cts/11-alu.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/11-alu.resized.pnl.v';
export CURRENT_SDC='./tmp/cts/11-alu.resized.sdc';
...
export PACKAGED_SCRIPT_7='./tmp/cts/11-alu.resized.sdc';
export PACKAGED_SCRIPT_8='./tmp/12-alu.sdc';
...
export SAVE_DEF='./tmp/12-alu.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/12-alu.odb';
export SAVE_POWERED_NETLIST='./tmp/12-alu.pnl.v';
export SAVE_SDC='./tmp/12-alu.sdc';
