...
set env CURRENT_DEF ./tmp/12-alu.def
set env CURRENT_NETLIST ./tmp/12-alu.nl.v
set env CURRENT_ODB ./tmp/12-alu.odb
set env CURRENT_POWERED_NETLIST ./tmp/12-alu.pnl.v
set env CURRENT_SDC ./tmp/12-alu.sdc
...
set env GRT_CONGESTION_REPORT_FILE ./tmp/routing/resizer-routing-timing-congestion.rpt
...
set env PACKAGED_SCRIPT_7 ./tmp/12-alu.sdc
