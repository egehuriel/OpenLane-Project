module alu (VPWR,
 ...
 sky130_fd_sc_hd__buf_8 _0654_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 _0685_ (.A(_0331_),
    ...
    .VPWR(VPWR),
    .X(_0599_));
 sky130_fd_sc_hd__a21oi_2 _0686_ (.A1(_0417_),
    .A2(_0449_),
    .B1(_0599_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_6 _0704_ (.A(net10),
    ...
    .VPWR(VPWR),
    .X(_0640_));
 sky130_fd_sc_hd__nand2_2 _0705_ (.A(_0640_),
    .B(_0638_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__buf_12 _0738_ (.A(_0003_),
    ...
    .VPWR(VPWR),
    .X(_0020_));
 sky130_fd_sc_hd__buf_8 _0739_ (.A(_0020_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0021_));
 sky130_fd_sc_hd__nand2_4 _0740_ (.A(_0001_),
    .B(_0642_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _0749_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_0031_));
 sky130_fd_sc_hd__nand2_4 _0750_ (.A(_0030_),
    .B(_0031_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_4 _0754_ (.A1(_0646_),
    ...
    .VPWR(VPWR),
    .X(_0036_));
 sky130_fd_sc_hd__clkbuf_8 _0755_ (.A(_0640_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_4 _0795_ (.A(_0043_),
    ...
    .VPWR(VPWR),
    .Y(_0077_));
 sky130_fd_sc_hd__inv_4 _0796_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2b_4 _0809_ (.A(_0071_),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__or2b_2 _0810_ (.A(_0090_),
    .B_N(_0071_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _0811_ (.A(_0091_),
    ...
    .VPWR(VPWR),
    .Y(_0093_));
 sky130_fd_sc_hd__clkinv_4 _0812_ (.A(_0067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a211o_2 _0828_ (.A1(_0026_),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__o31ai_1 _0829_ (.A1(_0021_),
    .A2(_0070_),
    .A3(_0108_),
    .B1(_0110_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3b_1 _0882_ (.A_N(net18),
    ...
    .VPWR(VPWR),
    .X(_0164_));
 sky130_fd_sc_hd__clkbuf_8 _0883_ (.A(_0164_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_4 _0976_ (.A(_0225_),
    ...
    .VPWR(VPWR),
    .X(_0254_));
 sky130_fd_sc_hd__buf_8 _0977_ (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand3_2 _0989_ (.A(_0230_),
    ...
    .VPWR(VPWR),
    .Y(_0268_));
 sky130_fd_sc_hd__and2_2 _0990_ (.A(_0267_),
    .B(_0268_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _0991_ (.A(_0236_),
    ...
    .VPWR(VPWR),
    .X(_0270_));
 sky130_fd_sc_hd__nand2_4 _0992_ (.A(_0236_),
    .B(_0269_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _0995_ (.A(_0272_),
    ...
    .VPWR(VPWR),
    .Y(_0274_));
 sky130_fd_sc_hd__nand2_4 _0996_ (.A(_0255_),
    .B(_0266_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_2 _1008_ (.A1(_0165_),
    ...
    .VPWR(VPWR),
    .X(_0289_));
 sky130_fd_sc_hd__a31o_2 _1009_ (.A1(net60),
    .A2(_0270_),
    .A3(_0271_),
    .B1(_0289_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_4 _1124_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_0413_));
 sky130_fd_sc_hd__nor2_4 _1125_ (.A(_0412_),
    .B(_0413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_2 _1140_ (.A1(_0349_),
    ...
    .VPWR(VPWR),
    .X(_0431_));
 sky130_fd_sc_hd__or2_1 _1141_ (.A(_0430_),
    .B(_0431_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a2bb2o_4 _1157_ (.A1_N(_0408_),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__o21ba_2 _1158_ (.A1(_0410_),
    .A2(_0411_),
    .B1_N(_0414_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__clkbuf_8 input3 (.A(A[2]),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__buf_12 input4 (.A(A[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 max_cap56 (.A(_0338_),
    ...
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__buf_2 max_cap57 (.A(_0299_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
