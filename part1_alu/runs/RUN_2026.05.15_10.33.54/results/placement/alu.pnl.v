module alu (VPWR,
 ...
 sky130_fd_sc_hd__buf_8 _0655_ (.A(_0266_),
    ...
    .VPWR(VPWR),
    .X(_0277_));
 sky130_fd_sc_hd__buf_6 _0656_ (.A(_0277_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_4 _0668_ (.A(_0352_),
    ...
    .VPWR(VPWR),
    .X(_0417_));
 sky130_fd_sc_hd__inv_4 _0669_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _0733_ (.A0(_0638_),
    ...
    .VPWR(VPWR),
    .X(_0015_));
 sky130_fd_sc_hd__clkbuf_16 _0734_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _0735_ (.A(_0277_),
    ...
    .VPWR(VPWR),
    .X(_0017_));
 sky130_fd_sc_hd__a21o_2 _0736_ (.A1(net45),
    .A2(_0017_),
    .B1(_0645_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_4 _0737_ (.A(_0016_),
    ...
    .VPWR(VPWR),
    .X(_0019_));
 sky130_fd_sc_hd__buf_8 _0738_ (.A(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkinv_4 _0751_ (.A(net4),
    ...
    .VPWR(VPWR),
    .Y(_0033_));
 sky130_fd_sc_hd__buf_8 _0752_ (.A(net4),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 _0798_ (.A(net3),
    ...
    .VPWR(VPWR),
    .X(_0080_));
 sky130_fd_sc_hd__clkbuf_16 _0799_ (.A(_0080_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o211a_4 _0802_ (.A1(_0063_),
    ...
    .VPWR(VPWR),
    .X(_0084_));
 sky130_fd_sc_hd__a211o_2 _0803_ (.A1(_0081_),
    .A2(_0082_),
    .B1(_0084_),
    .C1(_0352_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_4 _0819_ (.A(_0060_),
    ...
    .VPWR(VPWR),
    .Y(_0101_));
 sky130_fd_sc_hd__and2b_2 _0820_ (.A_N(_0046_),
    .B(_0027_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_2 _0826_ (.A1(_0026_),
    ...
    .VPWR(VPWR),
    .X(_0108_));
 sky130_fd_sc_hd__o211a_2 _0827_ (.A1(_0063_),
    .A2(_0064_),
    .B1(_0103_),
    .C1(_0068_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _0836_ (.A(_0094_),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__clkbuf_8 _0837_ (.A(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand3_4 _0856_ (.A(_0094_),
    ...
    .VPWR(VPWR),
    .Y(_0138_));
 sky130_fd_sc_hd__buf_8 _0857_ (.A(net1),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o22a_1 _0874_ (.A1(_0060_),
    ...
    .VPWR(VPWR),
    .X(_0156_));
 sky130_fd_sc_hd__buf_6 _0875_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 _0877_ (.A(net18),
    ...
    .VPWR(VPWR),
    .X(_0159_));
 sky130_fd_sc_hd__clkbuf_8 _0878_ (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_6 _0883_ (.A(_0164_),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__nor2_2 _0884_ (.A(_0159_),
    .B(_0157_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_2 _0895_ (.A(_0163_),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__clkbuf_1 _0896_ (.A(_0177_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_4 _0899_ (.A(_0178_),
    ...
    .VPWR(VPWR),
    .X(_0180_));
 sky130_fd_sc_hd__or3_1 _0900_ (.A(_0363_),
    .B(_0139_),
    .C(_0180_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o22a_1 _0913_ (.A1(_0135_),
    ...
    .VPWR(VPWR),
    .X(_0194_));
 sky130_fd_sc_hd__or3b_2 _0914_ (.A(_0189_),
    .B(_0192_),
    .C_N(_0194_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_4 _0959_ (.A(net4),
    ...
    .VPWR(VPWR),
    .X(_0238_));
 sky130_fd_sc_hd__or2_2 _0960_ (.A(_0034_),
    .B(_0021_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a31o_2 _1009_ (.A1(_0222_),
    ...
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__buf_8 _1010_ (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _1092_ (.A1(_0372_),
    ...
    .VPWR(VPWR),
    .X(_0379_));
 sky130_fd_sc_hd__a211oi_2 _1093_ (.A1(_0292_),
    .A2(_0295_),
    .B1(_0372_),
    .C1(_0375_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_4 _1111_ (.A1(_0363_),
    ...
    .VPWR(VPWR),
    .Y(_0399_));
 sky130_fd_sc_hd__a21o_1 _1112_ (.A1(_0373_),
    .A2(_0113_),
    .B1(_0378_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a41o_2 _1173_ (.A1(_0030_),
    ...
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__o22a_2 _1174_ (.A1(_0347_),
    .A2(_0599_),
    .B1(_0352_),
    .B2(_0471_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31ai_4 _1199_ (.A1(_0459_),
    ...
    .VPWR(VPWR),
    .Y(_0494_));
 sky130_fd_sc_hd__nand2_1 _1200_ (.A(_0034_),
    .B(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _1205_ (.A(_0497_),
    ...
    .VPWR(VPWR),
    .X(_0500_));
 sky130_fd_sc_hd__nor2_2 _1206_ (.A(_0499_),
    .B(_0500_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_4 _1215_ (.A1(_0472_),
    ...
    .VPWR(VPWR),
    .Y(_0511_));
 sky130_fd_sc_hd__and2_2 _1216_ (.A(_0510_),
    .B(_0511_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_2 _1295_ (.A(_0594_),
    ...
    .VPWR(VPWR),
    .Y(_0596_));
 sky130_fd_sc_hd__nand3_2 _1296_ (.A(_0574_),
    .B(_0576_),
    .C(_0596_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_4 _1297_ (.A1(_0574_),
    ...
    .VPWR(VPWR),
    .X(_0598_));
 sky130_fd_sc_hd__a31o_2 _1298_ (.A1(_0222_),
    .A2(_0597_),
    .A3(_0598_),
    .B1(net44),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_4 max_cap39 (.A(_0062_),
    ...
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__clkbuf_2 max_cap40 (.A(_0058_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 wire53 (.A(_0629_),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkbuf_2 max_cap54 (.A(_0430_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__buf_4 wire55 (.A(_0161_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__buf_4 wire56 (.A(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 max_cap59 (.A(_0222_),
    ...
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_4 wire60 (.A(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 max_cap61 (.A(net62),
    ...
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__clkbuf_4 wire62 (.A(_0320_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
