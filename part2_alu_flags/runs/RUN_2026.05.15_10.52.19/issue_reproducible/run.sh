...
export CURRENT_DEF='./results/placement/alu_flags.def';
export CURRENT_NETLIST='./results/placement/alu_flags.nl.v';
export CURRENT_ODB='./results/placement/alu_flags.odb';
export CURRENT_POWERED_NETLIST='./results/placement/alu_flags.pnl.v';
export CURRENT_SDC='./tmp/placement/8-resizer.sdc';
export DATA_WIRE_RC_LAYER='met2';
export DESIGN_NAME='alu_flags';
...
export PACKAGED_SCRIPT_7='./tmp/placement/8-resizer.sdc';
export PACKAGED_SCRIPT_8='./tmp/11-alu_flags.sdc';
...
export SAVE_DEF='./tmp/11-alu_flags.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/11-alu_flags.odb';
export SAVE_POWERED_NETLIST='./tmp/11-alu_flags.pnl.v';
export SAVE_SDC='./tmp/11-alu_flags.sdc';
