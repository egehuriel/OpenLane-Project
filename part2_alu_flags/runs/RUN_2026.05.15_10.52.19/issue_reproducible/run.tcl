...
set ::env(CURRENT_DEF) "./results/placement/alu_flags.def";
set ::env(CURRENT_NETLIST) "./results/placement/alu_flags.nl.v";
set ::env(CURRENT_ODB) "./results/placement/alu_flags.odb";
set ::env(CURRENT_POWERED_NETLIST) "./results/placement/alu_flags.pnl.v";
set ::env(CURRENT_SDC) "./tmp/placement/8-resizer.sdc";
...
set ::env(PACKAGED_SCRIPT_7) "./tmp/placement/8-resizer.sdc";
set ::env(PACKAGED_SCRIPT_8) "./tmp/11-alu_flags.sdc";
...
set ::env(SAVE_DEF) "./tmp/11-alu_flags.def";
set ::env(SAVE_NETLIST) "./out.v";
set ::env(SAVE_ODB) "./tmp/11-alu_flags.odb";
set ::env(SAVE_POWERED_NETLIST) "./tmp/11-alu_flags.pnl.v";
set ::env(SAVE_SDC) "./tmp/11-alu_flags.sdc";
